        ...
        const sections = `
            <div class="content-section animate-in">
                ...
                <ul class="feature-list">
                    ...
                    <li><strong>残差変動 (郡内変動・誤差変動)</strong>: 同じグループ内での個人差によるばらつき。<br>「同じ営業部でもAさんとBさんで成績が違う差」</li>
                </ul>

                <p><strong>【F検定】</strong><br>
                <code>$$ F = \\frac{要因の分散}{誤差の分散} $$</code><br>
                このF値が基準より大きければ（誤差による偶然のばらつきよりも、グループ間の明確な違いのせいだ！と言えるなら）「グループ間に有意な差がある」と判定します。</p>
            ...
            <div class="content-section animate-in stagger-1">
                ...
                <h3>単回帰モデルと最小二乗法</h3>
                <p>モデル式: <code>$$ y_i = \\beta_0 + \\beta_1 x_i + \\varepsilon_i $$</code></p>
                <ul>
